...
const weeknumber = () => {
    ...
    let termdate = new Date("4/18/2022");
    // set today's date
    let today = new Date();
...
const appendNestLMNT = (node, append1, append2, append3, append4, append5) => {
  ...
  export { isClass, isElement, getBase, getFilename, writeByClass, writeById, cleanInput, createLink, urlExists, qs, qsAll, createLMNT, appendNestLMNT, appendLMNT, weeknumber };